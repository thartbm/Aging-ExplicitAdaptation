...
Reach deviations of 30 degrees would fully counter the rotation, so it looks like all groups learned, that instruction helped, but also that older adults perhaps benefit less from the instructions.
...
As expected there is a main effect of training, i.e. there were reach aftereffects. In other words: the participants adapted to the rotation. There were other effects which we will explore below, but we subtract aligned reach deviations from those in the rotated session.
...
The lack of an effect suggests that explicit learning by instruction does not decrease reach aftereffects in either age group. Looking at the figure, it might even be that instructed older adults have slightly larger reach aftereffects.
